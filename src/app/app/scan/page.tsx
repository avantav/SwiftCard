...
export default async function ScanPage({ searchParams }: ScanPageProps) {
  ...
  return <main className="operations-page">
    ...
    <section className="operations-card operations-search-card" aria-labelledby="customer-search-title">
      <div className="operations-card-header"><h2 id="customer-search-title">Buscar cliente</h2><p>Usa el teléfono exacto o una parte del nombre.</p></div>
    ...
    {searchFailed || !search ? null : customers.length === 0 ? <div className="operations-empty-state"><h2>Sin resultados</h2><p>Revisa el teléfono o intenta con menos palabras del nombre.</p></div> : <section className="operations-results" aria-label={`${customers.length} resultados`}>
