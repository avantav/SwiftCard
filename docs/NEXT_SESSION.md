...
6. Task in progress: Implement CSV exports.
...
9. Pending commands: permission-scoped CSV export route and export tests.
...
11. Next exact action: Add `/admin/exports` with server-side CSV generation for scoped customers/purchases/rewards, never accepting tenant_id as authority and preserving minor-unit amounts.
