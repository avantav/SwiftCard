...
- [x] [Terminada] Align the multi-card Admin preview with the signed Apple `storeCard`, use each program's actual goal and unit names, and transactionally queue plus immediately dispatch installed-pass updates after card design, program or location changes.
