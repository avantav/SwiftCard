...
insert into public.customers (id, tenant_id, full_name, normalized_phone, privacy_consent, registration_method, source_branch_id, created_by_staff_id)
values ('30000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000001', 'Multi Reward Customer', '+528199999998', true, 'EMPLOYEE', '20000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000013');
insert into public.customer_loyalty_balances (tenant_id, customer_id, stamp_balance)
values ('10000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000004', 19);
...
declare result_record record;
begin
  select * into result_record from app.confirm_purchase('30000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000001', 'T-MULTI', 15000, null, null);
  if result_record.result <> 'CONFIRMED' or result_record.rewards_generated <> 2 then raise exception 'Purchase did not generate multiple rewards'; end if;
end;
$$;
